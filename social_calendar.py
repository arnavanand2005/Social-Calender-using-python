...
global cnx
global cur
cnx = mysq.connect(user='root',
passwd='password',host='localhost',database='CSProject')
cur=cnx.cursor()
...
#img=PhotoImage(file=r"C:\Users\STUDENT\Desktop\Student\Surya\pic2.png",master=
root)
...
def specbdays():
 ...
 z=(yu[1])
 # print(y,z,type(z))
 st="SELECT * FROM Birthdays WHERE Birthday_Month='{}' and
Birthday_Date={}".format(d1[yu[0]],yu[1])
 cur.execute(st)
 d=cur.fetchall()
 # print(d)
 if d==[]:
